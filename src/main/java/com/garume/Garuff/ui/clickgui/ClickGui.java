...
import com.garume.Garuff.module.modules.client.ColorMain;
...
public class ClickGui extends MinecraftHUDGUI {
	public static final int WIDTH=ClickGuiModule.INSTANCE.thinGui.isEnabled() ? 80 : 90,HEIGHT=12,DISTANCE=10,HUD_BORDER=2,SCROLL = 1;
	...
	public ClickGui() {
			theme = new GaruffTheme(new SettingsColorScheme(ClickGuiModule.INSTANCE.enabledColor, ClickGuiModule.INSTANCE.backgroundColor,ClickGuiModule.INSTANCE.settingBackgroundColor,ClickGuiModule.INSTANCE.outlineColor,ClickGuiModule.INSTANCE.fontColor,ClickGuiModule.INSTANCE.opacity),HEIGHT,2,SCROLL);
